...
PRCIDType	large_PRC_ROMS_325_rom[]	= {
                           {NNAME,       sysFileTPanel,sysFileCWirelessPanel,0},
                           ...
                           {NNAME, sysFileTApplication,    sysFileCMessaging,0},
                           ...
                           {NNAME, sysFileTApplication,       sysFileCRFDiag,0},
                           ...
                           {NNAME, sysFileTApplication,sysFileCMACUtilSerial,0},
                           ...
                           {NNAME,     sysFileTLibrary,         sysFileCrdio,0},
                           {NNAME,      sysFileTExgLib,        sysFileCIrLib,0},
                           {NNAME,     sysFileTLibrary,      sysFileCINetLib,0},
